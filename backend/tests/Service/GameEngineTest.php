...
class GameEngineTest extends TestCase
{
    ...
    public function testDropPieceInEmptyColumn(): void
    {
        ...
        // Player 1 drops piece in column 3
    ...
    public function testDropPieceOutOfBounds(): void
    {
        ...
        $rowIndex = $this->engine->dropPiece($board, -1, 1);
        $this->assertSame(-1, $rowIndex);

        $rowIndex = $this->engine->dropPiece($board, GameEngine::COLS, 1);
        $this->assertSame(-1, $rowIndex);
    }
    ...
    public function testCheckDraw(): void
    {
        $board = $this->createEmptyBoard();
        ...
        for ($c = 0; $c < GameEngine::COLS; $c++) {
            $board[0][$c] = ($c % 2) + 1; // Arbitrary player IDs
        }
