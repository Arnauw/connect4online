...
final class Version20260308032806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, board JSON DEFAULT NULL, current_turn INT DEFAULT NULL, status VARCHAR(20) DEFAULT NULL, room_code VARCHAR(10) DEFAULT NULL, player1_id INT DEFAULT NULL, player2_id INT DEFAULT NULL, winner_id INT DEFAULT NULL, PRIMARY KEY (id))');
