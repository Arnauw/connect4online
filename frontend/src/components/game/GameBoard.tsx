...
export const GameBoard = ({ title = "Game" }: { title?: string }) => {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center relative">
            ...
            <div className="grow flex flex-col justify-center items-center w-full pb-10">
                ...
                <div className="bg-blue-600/90 p-3 md:p-4 rounded-2xl shadow-[0_0_30px_rgba(37,99,235,0.6)] border-2 border-blue-400/50 backdrop-blur-sm">
