    ...
    return (
        <>
            <div className="absolute top-6 right-6 flex flex-col items-end gap-3 z-50 animate-fade-in">
                ...
                <div
                    className="flex items-center gap-4 bg-slate-900/80 p-2 pr-4 pl-6 rounded-full border border-slate-700 shadow-lg backdrop-blur-md">
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-100 flex items-center justify-center p-4">
                    <div
                        className="bg-slate-900 border-2 border-slate-700 rounded-2xl p-6 w-full max-w-sm shadow-[0_0_40px_rgba(248,113,113,0.3)] text-center animate-bounce-in">
