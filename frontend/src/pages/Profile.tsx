        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-6 gap-8">
            ...
            <div className="bg-slate-900/80 p-8 rounded-2xl border-2 border-cyan-500/30 w-full max-w-md shadow-[0_0_30px_rgba(34,211,238,0.1)]">
                <div className="flex flex-col gap-4 text-center">
                    <div className="w-24 h-24 bg-slate-700 rounded-full mx-auto mb-4 border-2 border-cyan-400 shadow-[0_0_15px_cyan] flex items-center justify-center text-3xl">
                        👤
                    </div>
